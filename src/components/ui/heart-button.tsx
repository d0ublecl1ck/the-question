...
export function HeartButton({ initialCount = 16, label = "Like", maxClicks = 5 }: HeartButtonProps) {
    ...
    <div className="relative">
      ...
      >
        <motion.div
          ...
          whileTap={isCompleted ? animations.heart.tapCompleted : animations.heart.tapActive}
