...
export default function LibraryPage() {
  ...
  const summary = useMemo(() => {
    ...
    return {
      total: items.length,
      average: totals.rating / items.length,
    ...
    <section className="w-full space-y-20">
      <header className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl font-semibold leading-tight text-foreground sm:text-5xl">收藏工作台</h1>
            ...
            <div className="max-w-sm space-y-3 text-sm text-slate-600">
              ...
              <div className="grid grid-cols-3 gap-3 pt-2 text-xs">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-xl font-semibold text-slate-700">{summary.average.toFixed(1)}</div>
                </div>
                <div className="space-y-1">
